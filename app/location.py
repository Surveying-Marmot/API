...
class Location_API(Resource):
    ...
    def get(self):
        ...
        if location:
            url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" + str(location['latitude'])+"," + str(location['longitude']) + "&radius=1000&keyword=point of interest&key="+app.config['GOOGLE_KEY']
